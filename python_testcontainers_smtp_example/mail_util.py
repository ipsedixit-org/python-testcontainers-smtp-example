...
def send(host: str, port: int, from_addr: str, to_addrs: list[str], subject: str, msg_body: str):
    """
    ...
    try:
        ...
        logging.info("Send mail from_addr: %s - to_addrs: %s - msg: %s", from_addr, to_addrs, msg)
